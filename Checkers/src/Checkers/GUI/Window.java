...
import Checkers.BoardAndGame.AIGame;
import Checkers.BoardAndGame.Game;
...
public class Window extends javax.swing.JPanel {
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        if (t1 == null || t2 == null) {
            ...
            //Użytkownik wybrał‚ poprawne ustawienia gry
            //Zamykamy okno ustawień„ i rozpoczynamy grę
            cgui.newGame((ifAI) ? new AIGame(t1, t2) : new Game(t1, t2));
            wf.setVisible(false);
        }
